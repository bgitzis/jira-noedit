...
- Blocks click-to-edit on issue title, description, comments, and the current-issue breadcrumb self-link. A 🔒 / 🔓 button floats in the top-right corner; click it to toggle.
...
4. Visit a Jira issue — a 🔒 button appears top-right; clicks on title/description/comments/self-breadcrumb are blocked
